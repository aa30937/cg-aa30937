...
function animate() {
    ...
    // Move torus left and right
    torusMesh.position.x += speed * direction;
    
    if (torusMesh.position.x >= rightLimit) direction = -1;
    if (torusMesh.position.x <= leftLimit) direction = 1;
